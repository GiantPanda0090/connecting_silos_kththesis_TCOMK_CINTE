...
def list_submissions(course_id,assignment_id):
       ...
       url = baseUrl + '%s/assignments/%s/submissions' % (course_id,assignment_id) #/api/v1/courses/:course_id/assignments/:id
       #print (url)
       if Verbose_Flag:
              print("url: " + url)
       ...
       assignment_return=r.json()
       out_list=[]
       i=0
       for items in assignment_return:
        #print (items)
        if items['workflow_state'] !='unsubmitted':
               ...
               if user_id == profil['id']:
                     out_list.append([user_id,profil['name'],profil['login_id']])
                      ...
                      print("Expected: "+ profil['id'])
                      print("Actual: " + user_id)
               i += 1
...
def main(course_id,assignment_id):
       global Verbose_Flag
       ...
       out_list=list_submissions(course_id,assignment_id)
       print (out_list)
              #print (profil['name'])
