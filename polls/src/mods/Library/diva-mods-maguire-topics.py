...
#        print "Thesis_count	Abstracts_eng_swe	Abstracts_eng	Abstracts_swe	Abstracts_missing"
    ...
    headings = ['School', 'Thesis_count', 'Abstracts_eng_swe', 'Abstracts_eng', 'Abstracts_swe', 'Abstracts_missing', 'Abstracts_nor', 'Abstracts_ger',]
    ...
    for key in keylist:
        entry=Schools[key]
        out_row = [key, str(entry['Thesis_count']), str(entry['Abstracts_eng_swe']), str(entry['Abstracts_eng']), str(entry['Abstracts_swe']), str(entry['Abstracts_missing']), str(entry['Abstracts_nor']), str(entry['Abstracts_ger']),]
#
        if Verbose_Flag:
            print out_row
