#!/usr/bin/python3
#
# ./list-modules.py course_id
#
# outputs a summary of the modules in a course
# also outputs an xlsx file of the form: modules-course_id.xlsx
#
...
def main():
       ...
       if (len(remainder) < 1):
              ...
              if (output):
                     ...
                     writer = pd.ExcelWriter('modules-'+str(course_id)+'.xlsx', engine='xlsxwriter')
