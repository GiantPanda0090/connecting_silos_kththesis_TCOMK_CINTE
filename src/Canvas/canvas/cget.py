#!  /usr/bin/env python3
#
# ./cget.py  canvas_course_page_url
# 
# get a given Canvas course page, save as xxxx.html where xxxx is the last part of the URL
#
#
# Example:
#   cget.py https://kth.instructure.com/courses/11/pages/notes-20160716
#
# produces the file notes-20160716.html
#
# G. Q: Maguire Jr.
#
# 2016.07.19
...
def main():
       ...
       if (len(remainder) < 1):
              ...
              output=get_course_page(canvas_course_page_url)
              if (output):
                     if Verbose_Flag:
                            pprint(output)
