#!/usr/bin/python3
#
# ./export-course-announcements.py course_id [start_date [end-date]]
# with the dates in YYYY-MM-DD format
#
# outputs the course announcement for the specified course, optionally limited to the range of dates specified, as a spreadsheet
#
# G. Q. Maguire Jr.
#
# 2017.03.25
...
def main():
       ...
       if (len(remainder) < 1):
              ...
              if (output):
                     ...
                     writer = pd.ExcelWriter('announcements-'+str(course_id)+'.xlsx', engine='xlsxwriter')
                     # Convert the dataframe to an XlsxWriter Excel object.
                     df.to_excel(writer, sheet_name='Announcements')
