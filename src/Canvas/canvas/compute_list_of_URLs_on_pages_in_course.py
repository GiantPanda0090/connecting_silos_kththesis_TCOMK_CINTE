#!/usr/bin/python3
#
# ./compute_list_of_URLs_on_pages_in_course.py  course_id
# 
...
def compute_stats_for_pages_in_course(course_id):
       ...
       for p in list_of_all_pages:
              ...
              try:
                     ...
                     page_entry={"url": url, "page_name": fixed_title, "unique URLs": raw_links}
...
def main():
       ...
       if (len(remainder) < 1):
              ...
              if (output):
                     if Verbose_Flag:
                            print(output)
                     with open('URLs_for_course_'+course_id+'.csv', "wb") as writer:
