#!/usr/bin/python3
#
# ./list-course-announcements.py course_id [start_date [end-date]]
# with the dates in YYYY-MM-DD format
#
# outputs the course announcements for the specified course, optionally limited to the range of dates specified
#
# G. Q. Maguire Jr.
#
# 2017.03.24
