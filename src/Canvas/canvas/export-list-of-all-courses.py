#!/usr/bin/python3
#
# ./export-list-of-all-courses.py account_id
#
# outputs the list of courses for the specified account course
#
# G. Q. Maguire Jr.
#
# 2017.03.31
...
def main():
       ...
       if (len(remainder) < 1):
              ...
              if (output):
                     ...
                     writer = pd.ExcelWriter('courses-'+str(account_id)+'.xlsx', engine='xlsxwriter')
