#!  /usr/bin/env python3
#
# ./ccreate.py  canvas_course_page_url page_title
# 
# create a new Canvas course page xxxx.html where xxxx is the last part of the URL, with the indicated title
#
#
# Example:
#   ccreate.py https://kth.instructure.com/courses/11/pages/notes-20160716 "Notes-2016+716"
#
...
def main():
       ...
       if (len(remainder) < 2):
              print("Inusffient arguments\n must provide url page_title\n")
       else:
              canvas_course_page_url=remainder[0]
              page_title=remainder[1]

              output=create_course_page(canvas_course_page_url, page_title)
              if (output):
                     if Verbose_Flag:
                            pprint(output)
